...
const ContactIconVariant = 'gradient';
...
const useStyles = createStyles((theme, { variant }) => ({
  ...
  title: {
    color: variant === 'gradient' ? theme.black : theme.colors[4],
  },
...
const MOCKDATA = [
  { title: 'Email', description: 'hello@professionalhub.com', icon: IconAt },
  { title: 'Phone', description: '+46 (800) 335 35 35', icon: IconPhone },
  { title: 'Address', description: 'Stockholm center', icon: IconMapPin },
